...
public class PlayerInput : MonoBehaviour
{
    ...
    public bool Interact => !Player.Instance.InShadowStep && !Player.Instance.InCutscene && !Player.Instance.Tutorial && !PauseHandler.Instance.InPause && !_dying && !PossessionHandler.Instance.ChoosingPosition && !Player.Instance.Reading && !Player.Instance.InDialogue && _controls.Player.Interact.triggered;
